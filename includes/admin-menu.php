...
function librebooking_base_url_callback() {
    $base_url = esc_attr(get_option('librebooking_base_url', 'https://booking.9700-paintball.dk/'));
    echo '<input type="text" name="librebooking_base_url" value="' . $base_url . '" class="regular-text">';
}
